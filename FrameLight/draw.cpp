...
void draw_palla() {
  ...
  GLfloat cubeMater[] = { (GLfloat)0.2, (GLfloat)0.2, (GLfloat)1.0, (GLfloat)1.0 };
...
void draw_tetra() {
  ...
  glColor3f((GLfloat)1.0, (GLfloat)0.2, (GLfloat)0.2);
  glBegin(GL_TRIANGLES);
  normale9f(-0.5, -H1, -H1, 0.5, -H1, -H1, 0.0, H2, -H1);
  glVertex3f(-0.5, -H1, -H1); glVertex3f(0.5, -H1, -H1); glVertex3f(0.0, H2, -H1);
  normale9f(-0.5, -H1, -H1, 0.0, H2, -H1, 0.0, 0.0, H2);
  glVertex3f(-0.5, -H1, -H1); glVertex3f(0.0, H2, -H1); glVertex3f(0.0, 0.0, H2);
  normale9f(-0.5, -H1, -H1, 0.0, 0.0, H2, 0.5, -H1, -H1);
  glVertex3f(-0.5, -H1, -H1); glVertex3f(0.0, 0.0, H2); glVertex3f(0.5, -H1, -H1);
  normale9f(0.0, 0.0, H2, 0.0, H2, -H1, 0.5, -H1, -H1);
  glVertex3f(0.0, 0.0, H2); glVertex3f(0.0, H2, -H1); glVertex3f(0.5, -H1, -H1);
  glEnd();
