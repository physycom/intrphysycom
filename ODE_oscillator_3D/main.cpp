...
//-----------------------------------------------------------
void force( Stato &s){
    for(int i=0; i< N_DIM; i++) s.a[i]= -s.x[i];        
}
//-----------------------------------------------------------
...
void next_s2(){
    ...
    for(int i=0; i< N_DIM; i++) s.x[i]= s.x[i] +s.v[i]*delta/2;
    t= t +delta/2; force(s);
    for(int i=0; i< N_DIM; i++) s.v[i]= s.v[i] +s.a[i]*delta;
    for(int i=0; i< N_DIM; i++) s.x[i]= s.x[i] +s.v[i]*delta/2;
    t= t +delta/2;
}
//-----------------------------------------------------------
void next_rk4(){
    ...
    for(int i=0; i< N_DIM; i++){
        s.x[i]= s.x[i] +(s.v[i]+2*sw1.v[i]+2*sw2.v[i]+sw3.v[i])*delta/6;
        s.v[i]= s.v[i] +(s.a[i]+2*sw1.a[i]+2*sw2.a[i]+sw3.a[i])*delta/6;
    }
}
//-----------------------------------------------------------
