...
//-----------------------------------------------------------
void forze(double x_,double t_){
    xdot=  x_;
}
//-----------------------------------------------------------
void next_Eulero(void){
    forze(x,t);
    x= x + xdot*delta;
    t= t+ delta;
}
...
void next_rk4(){
    ...
    forze(x,t);           xdot1=xdot;
    x1= x + xdot1*delta/2;
    forze(x1,t+delta/2);  xdot2=xdot; 
    x2= x + xdot2*delta/2;  
    forze(x2,t+delta/2);  xdot3=xdot; 
    x3= x + xdot3*delta;    
    forze(x3,t+delta);    xdot4=xdot;
