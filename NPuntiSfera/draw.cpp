...
void DisegnaPunti(void);
void DrawTriangle(int k0,int k1,int k2);
void DisegnaTriangoli(void);
...
void DrawTriangle(int k0,int k1,int k2){
     ...
     glBegin (GL_TRIANGLES);              
       glVertex3f(x[k0],y[k0],z[k0]); glVertex3f(x[k1],y[k1],z[k1]); glVertex3f(x[k2],y[k2],z[k2]);
     glEnd();                      
}
//---------------------------------------------------------------------------------------
void DisegnaTriangoli(void){
      ...
      for( k=0; k<N_PUNTI; k++ ){           
         ...
         glPushMatrix();
           DrawTriangle(k0,k1,k2); DrawTriangle(k0,k1,k3); DrawTriangle(k0,k1,k4); DrawTriangle(k0,k1,k5); DrawTriangle(k0,k1,k6);
           DrawTriangle(k0,k2,k3); DrawTriangle(k0,k2,k4); DrawTriangle(k0,k2,k5); DrawTriangle(k0,k2,k6);
           DrawTriangle(k0,k3,k4); DrawTriangle(k0,k3,k5); DrawTriangle(k0,k3,k6);
           DrawTriangle(k0,k4,k5); DrawTriangle(k0,k4,k6);
